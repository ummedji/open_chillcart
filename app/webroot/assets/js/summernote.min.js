    ...
    var c = {
        ...
        var d = new m, e = new o, g = new p, j = new q, k = new r, l = function (b) {
            ...
            if (h.length > 0) {
                ...
                if (d[n] && (v.trigger("focus"), d[n](v, o, m)), -1 !== a.inArray(n, ["backColor", "foreColor"]))e.updateRecentColor(h[0], n, o); else if ("showLinkDialog" === n) {
                    v.focus();
                    var A = d.getLinkInfo();
        ...
        this.bindKeyMap = function (a, b) {
            ...
            if (g.on("mousemove", C), a.editable.on("blur", function () {
                ...
                c.bMSIE ? a.editable.on("DOMCharacterDataModified, DOMSubtreeModified, DOMNodeInserted", h) : a.editable.on("input", h)
            }
