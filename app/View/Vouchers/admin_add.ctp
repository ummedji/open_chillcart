<div class="contain">
	<div class="contain">
		<h3 class="page-title">Add Voucher</h3>
		<div class="page-bar">
			...
			<div class="col-md-12">
				...
				<div class="portlet box blue-hoki">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-user"></i> Add Voucher
						</div>
						<div class="tools">
					...
					<div class="portlet-body form">
						<form action="#" id="form-username" class="form-horizontal" method="POST">
							<div class="form-body">
								...
								<div class="form-group">
									...
									<div class="col-md-8 col-lg-8">
                                    	...
                                    	echo $this->Form->radio('Voucher.offer_mode',$option2,
                                             ...
                                             <div class="row">
	                                            <div class="col-md-4">
													<?php echo $this->Form->input('Voucher.offer_value',
		                    										array('class'=>'form-control',
		                    											  'autocomplete' => 'off',
		                                                                  'label' => false,
		                    											  'div' => false));
