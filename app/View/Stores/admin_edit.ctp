	...
	<div class="contain">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li>
					<a href="<?php echo $siteUrl.'/admin/stores/index';?>">Manage Store</a>
					<i class="fa fa-angle-right"></i>
				</li>
				<li>
						...
						echo $this->Form->create('Store',array('class'=>'form-horizontal',
							...
							<div class="tab-content"> 
										...
										<div class="form-group">
											...
											<div class="col-md-6 col-lg-4"> <?php
										        ...
										        echo $this->Form->input('org_logo',
											        ...
											        <img class="img-responsive img_fields" src="https://s3-eu-west-1.amazonaws.com/<?php echo $siteBucket.'/storelogos/'.$this->request->data['Store']['store_logo']; ?>">
								...
								<div class="tab-pane fade" id="comission">
									<div class="row contain">
										<div class="col-md-offset-3 col-md-6 col-lg-4"> 
											<label id="comissionError" class="error"></label>
										</div>
									</div>
									<div class="form-body">
										<div class="form-group">
