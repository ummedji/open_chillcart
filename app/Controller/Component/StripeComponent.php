...
class StripeComponent extends Component
{
     ...
     * @access public
     */
    public $fields = array("stripe_id" => 'id', "object" => "object", "created" => 'created', "livemode" => 'livemode', "paid" => "paid", "status" => "status", "amount" => "amount", "currency" => "currency", "refunded" => "refunded", "source" => "source");
